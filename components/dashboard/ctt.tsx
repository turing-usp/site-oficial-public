...
export default function CTT(dados: any) {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row items-start h-screen">
                    <div className="flex flex-col w-full md:w-[20%] h-auto">
                        <h1 className="text-white text-[1.5rem] text-center my-0 md:my-[3%] font-bold">Contatos:</h1>
                        <div className="flex flex-row gap-[5%] md:flex-col" >
                            <div className={`flex w-full my-[5%] h-[12vh] border border-gray-700 rounded-[0.5rem] ${abaselect === "turing" ? "bg-[#F1863D]" : ""} hover:bg-[#F1863D] cursor-pointer`} onClick={() => handleSelect("quero ser turing")}>
                                <div className="flex w-auto md:w-[90%] mx-[5%] items-center justify-center">  
                    ...
                    <div className="flex flex-col w-full md:flex-1 h-full md:p-8"> 
                        ...
                        <div className="flex-col">
                            {cttfocado ? (
                                ...
                                <div className="bg-gray-800 md:p-8 rounded-lg border border-gray-700">
