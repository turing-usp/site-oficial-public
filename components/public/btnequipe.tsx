                        ...
                        {(abaAtiva === 1 || abaAtiva === 2) && (
                            (abaAtiva === 1 ? area_de_foco : area_de_gestao).map((area) => (
                                <button
                                    ...
                                    className={`whitespace-nowrap mx-[2%] my-[5%] text-[0.8rem] md:text-[1.2rem] px-6 h-[4rem] md:flex-1 md:h-[4rem] lg:h-[8vh] xl:flex-1 rounded-[1rem] no-scrollbar border border-[#F1863D] cursor-pointer duration-500 ease-in-out ${
