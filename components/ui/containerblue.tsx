...
export default async function ContainerBlue({ children }: ContainerBlueProps) {
    ...
    return(
            <div className="flex h-auto w-[100%] min-h-[100vh]">
                        <div className="hidden md:flex md:w-[10%] mx-[5%] mt-[5%]">
                            <Subnav pages={pages} />
                        </div>
                        <div className="flex h-auto w-full overflow-hidden rounded-[2rem] mx-[5%] mt-[16%] md:mx-0 md:w-[80%] bg-[#162B3F] md:rounded-tl-[2rem] md:rounded-bl-[2rem] md:mt-[5%]">
