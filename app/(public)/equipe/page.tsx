            ...
            <div className="relative flex min-h-fit md:h-[100vh] w-full items-start justify-center pt-[20vh] pb-10 overflow-hidden">
                        <div className="flex flex-1 items-center relative self-center">
                            ...
                            <Image 
                                ...
                                width={600}
                                height={600}
                                className="absolute left-0 h-[50vh] md:h-[40vh] w-auto -translate-y-30 md:translate-y-0"
                            />
                        </div>
                        ...
                        <div className="flex flex-1 items-center relative self-center">
                            ...
                            <Image 
                                ...
                                width={600}
                                height={600}
                                className="absolute right-0 h-[35vh] w-auto translate-y-30 md:translate-y-0"
                            />
                        </div>
            </div>
            <div>
