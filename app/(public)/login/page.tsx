...
export default function Login() {
    return (
        <main>
            <div className='flex flex-col md:flex-row min-h-screen md:min-h-[100vh] lg:h-[100vh] w-full items-center justify-center py-10 md:py-0'>
                <div className="flex flex-col md:flex-row mx-[5%] mt-[5%] w-[90%] gap-10 md:gap-0">
                    <div className='flex flex-1 justify-center items-center'>
                        <div className='flex flex-col bg-[#162B3F] min-h-[60vh] w-full md:w-[100%] md:min-h-[50rem] lg:w-[70%] lg:min-h-[60vh] lg:h-[80vh] rounded-[2rem] items-center justify-center py-[10%] px-6 mt-[5%]'>
                            <Image
                                src="/cadeado.svg"
                                alt="Login Image"
                                width={300}
                            ...
                            <p className='text-[#FFFFFF] text-[0.9rem] lg:text-[1rem] text-center px-4'>Digite seu email e senha cadastrados para acessar sua conta Turing! Em caso de esquecimento, utilize a opção de recuperação de senha.</p>
                        </div>
                    </div>
                            ...
                            <form action={handleLogin}>
                                <div className="w-full flex flex-col items-center">
                                    ...
                                    <input
                                        ...
                                        required
                                        autoComplete="email"
                                        className='h-[5vh] md:mb-[3%] lg:mb-0 w-full bg-transparent text-black text-[1rem] focus:outline-none border-b-[0.1rem] border-black/50 placeholder:text-gray-400 text-left px-1'
                                    />
                                    <Senha/>
