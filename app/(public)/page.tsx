    ...
    return (
        <main>
            ...
            <div id='secao azul' className='flex flex-col min-h-screen pb-16 z-0 relative bg-[#162B3F]'>
                ...
                <div className='flex flex-col md:flex-row mr-[5%] ml-[5%] mt-[5%] gap-y-10 md:gap-[5%] md:gap-[10%] items-center'>
                   <div className='bg-[#FFFFFF] w-full md:flex-1 min-h-[420px] py-14 md:min-h-[320px] md:h-[60vh] max-w-[400px] flex flex-col items-center justify-center rounded-[1rem] hover:scale-105 transition-transform duration-500'>
                        <Image 
                            src="/ssd.svg"
                            alt="SSD"
                            width={800}
            ...
            <div className='flex flex-col min-h-screen md:h-[100vh] z-0 items-center mt-[10%] md:mt-[5%] relative'>
                ...
                />
                <div className='relative md:absolute z-10 mt-[10%] w-[70%]'>
                    <Carousel/>
                </div>
            </div>
