    ...
    return (
        <main>
            <div className='h-[100vh] flex flex-col md:flex-row z-0 items-center'>
                <div className='ml-[5%] mr-[5%] flex flex-col w-full md:w-[45%] items-center md:items-start lg:items-center justify-center h-[100%]'>
                    <p className='text-[#000000] text-[2.2rem] md:text-[3rem] lg:text-[4rem] text-center font-bold leading-tight px-4 md:px-0'>CONSTRUINDO O FUTURO DA <span className='text-[#F1863D]'>IA</span></p>
            ...
            <div className='flex flex-col md:flex-row items-center py-16 md:h-[100vh] z-0 relative'>
                <div className='md:ml-[2%] lg:ml-[5%] md:mr-[3%] lg:mr-0 flex flex-col w-full md:w-[40%] lg:w-[45%] items-center justify-center h-auto md:h-[100%] order-2 md:order-1'>
                    <Image
                        ...
                        width={800}
                        height={800}
                        className='w-[85%] md:w-[90%] lg:w-[55vh] h-auto border border-[#F1863D] border-[0.2rem] mb-[5%] mt-[5%] md:mt-0 rotate-354'
                    />
                    <Image
                        src="/fotointeg.jpg"
                        alt=""
                        width={800}
                        height={800}
                        className='w-[85%] md:w-[90%] lg:w-[55vh] h-auto border border-[#F1863D] border-[0.2rem] rotate-6'
                    />
                </div>
                <div className='mr-[5%] flex flex-col w-full md:w-[50%] lg:w-[45%] pb-10 md:pb-0 order-1 md:order-2'>
                    <p className='text-[#000000] text-[2.2rem] md:text-[2.5rem] lg:text-[3rem] font-bold ml-[5%] md:ml-0'>QUEM SOMOS</p>
            ...
            <div id='secao azul' className='flex flex-col min-h-screen pb-16 z-0 relative bg-[#162B3F]'>
                ...
                <div className='flex flex-col md:flex-row mr-[5%] ml-[5%] mt-[5%] md:mt-[20%] lg:mt-[5%] gap-y-10 md:gap-[5%] md:gap-[10%] items-center md:justify-center'>
                   <div className='bg-[#FFFFFF] w-full md:flex-1 min-h-[420px] py-14 md:min-h-[320px] md:h-[60vh] max-w-[300px] md:max-w-[400px] flex flex-col items-center justify-center rounded-[1rem] hover:scale-105 transition-transform duration-500'>
                        ...
                        <p className=' text-[#000000] text-[1rem] mx-[10%] text-center md:text-center lg:text-justify'>Exploramos artigos científicos e descobertas para aplicarmos em necessidades do cotidiano.</p>
                   </div>
                   <div className='bg-[#FFFFFF] w-full md:flex-1 min-h-[420px] py-14 md:min-h-[320px] md:h-[60vh] max-w-[300px] md:max-w-[400px] flex flex-col items-center justify-center rounded-[1rem] hover:scale-105 transition-transform duration-500'>
                        <Image 
                            src="/processador.svg"
                        ...
                        <p className=' text-[#000000] text-[1rem] mx-[10%] text-center md:text-center lg:text-justify'>Transformamos teoria em código. Desenvolvemos modelos inéditos e aplicações robustas para diversos tipos de uso.</p>
                   </div>
                   <div className='bg-[#FFFFFF] w-full md:flex-1 min-h-[420px] py-14 md:min-h-[320px] md:h-[60vh] max-w-[300px] md:max-w-[400px] flex flex-col items-center justify-center rounded-[1rem] hover:scale-105 transition-transform duration-500'>
                        <Image 
                            src="/share.svg"
                        ...
                        <p className=' text-[#000000] text-[1rem] mx-[10%] text-center lg:text-justify'>Democratizamos o conhecimento técnico através de cursos, workshops e conteúdos abertos, conectando a USP à sociedade e ao mercado.</p>
                   </div>
                </div>
            </div>
