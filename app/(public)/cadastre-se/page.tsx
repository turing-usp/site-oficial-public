    ...
    return(
        ...
        <div className="flex h-auto my-[2%] min-h-[100vh]">
            <div className="flex mx-[5%] items-center justify-center w-[90%]">
                <div className="flex flex-col flex-1 h-[80vh] w-[70%] bg-[#162B3F] rounded-[2rem] items-center justify-between">
                    <Image
                        src="/cadastro.svg"
                        alt="Imagem de cadastro"
                        width={600}
                        height={600}
                        className="mt-[5%] h-[15vh] w-auto "
                    />
                    <div className = "flex flex-col items-center mb-[40%]">
                        <p className='text-[#FFFFFF] text-[2rem] font-bold'>BEM VINDO!</p>
