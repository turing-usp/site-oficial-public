        ...
        <main>
                ...
                <div className="hidden lg:flex flex-1 items-center relative">
                    ...
                    <div className="flex flex-1 items-center lg:relative">
                        <Image 
                            ...
                            width={600}
                            height={600}
                            className="h-[14rem] lg:h-[40vh] absolute left-0 w-auto"
                        />
                    </div>
            </div>
            <div className="flex justify-center">
                <p className='text-[2rem] mx-[5%] my-[5%] lg:text-[3rem] lg:ml-[10%] lg:my-0 w-full text-[#000000] font-bold text-left'>NOSSOS EVENTOS</p>
            </div>
            ...
            <div id='secao azul' className='flex flex-col min-h-screen h-auto z-0 relative bg-[#162B3F]'>
                <div className='flex justify-center mt-[5%]'>
                    <p className='text-[2rem] mx-[5%] lg:mx-0 lg:text-[3rem] lg:mr-[10%] lg:text-right w-full text-[#FFFFFF] font-bold'>NOSSAS COMPETIÇÕES</p>
                </div>
                <div className='flex flex-col lg:flex-row mr-[5%] ml-[5%] mt-[5%] gap-[10%]'>
                    <div className='bg-[#FFFFFF] flex-1 h-auto mb-[5%] flex flex-col items-center justify-start rounded-[1rem] hover:lg:scale-105 transition-transform duration-500 p-8'>
                        ...
                        <p className=' text-[#000000] text-[1rem] lg:text-[1.5rem] text-center mx-[10%] mb-[5%]'>ITAÚ QUANT</p>
