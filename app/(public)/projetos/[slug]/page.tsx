        ...
        <div>
            <div className="min-h-[50dvh] py-20 lg:h-[88vh] lg:py-0 flex flex-row w-[100%] justify-center items-center">
                <div className="flex flex-col lg:flex-row mx-[5%]">
                    <p className="text-[1.5rem] md:text-[2rem] lg:text-[4rem] flex flex-1 text-[#000000]">{projeto.titulo}</p>
                    <p className="text-[0.8rem] md:text-[1rem] lg:text-[1.4rem] flex flex-1 text-[#000000]">{projeto.resumo}</p>
                </div>
            </div>
            ...
            <div className="min-h-[20dvh] py-10 lg:h-[10rem] lg:py-0 flex w-[100%] justify-center items-center">
                <div className="flex flex-col lg:flex-row mx-[5%] w-[100%] justify-between">
                    <div className="flex flex-1 flex-col items-center">
                        <p className="text-[1.2rem] md:text-[1.5rem] lg:text-[2rem] text-[#000000] font-bold mb-[2%]">Categorias:</p>
                    ...
                    <div className="mb-[5%] lg:mb-0 flex flex-1 flex-col items-center">
                        <p className="text-[1.2rem] md:text-[1.5rem] lg:text-[2rem] text-[#000000] font-bold mb-[2%]">Anos:</p>
                        <p className="text-[1rem] text-[#000000] lg:text-[1rem]">{projeto.anoinicio} - {projeto.anofim}</p>
                    </div>
                    <div className="flex flex-1 flex-col items-center">
                        <p className="text-[1.2rem] md:text-[1.5rem] lg:text-[2rem] text-[#000000] font-bold mb-[2%]">Áreas:</p>
                        <div className="flex gap-[5%]">
                            {areas_de_projeto.map((area, index: number) => (
                                <p key={index} className="text-[0.7rem] w-[7rem] md:text-[0.8rem] lg:text-[0.9rem] lg:w-[8rem] flex items-center justify-center text-[#000000] border border-[#F1863D] rounded rounded-[2rem] min-h-[2rem] text-center">{area}</p>
                            ))}
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col mx-[5%] mb-[5%] min-h-[20vh] h-auto w-[90%] items-center ">
                ...
                <p className="text-[#000000] text-[1.2rem] md:text-[1.5rem] lg:text-[3rem] font-bold text-center mb-[5%]">PROBLEMA</p>
                <p className="text-[#000000] text-[0.8rem] md:text-[1rem] lg:text-[1.2rem] mb-[2%]">{projeto.problema}</p>
            </div>
            <div className="flex flex-col mx-[5%] mb-[5%] min-h-[20vh] h-auto w-[90%] items-center ">
                ...
                <p className="text-[#000000] text-[1.2rem] md:text-[1.5rem] lg:text-[3rem] font-bold text-center mb-[5%]">CONFECÇÃO</p>
                <p className="text-[#000000] text-[0.8rem] md:text-[1rem] lg:text-[1.2rem] mb-[2%]">{projeto.confeccao}</p>
            </div>
            <div className="flex flex-col mx-[5%] mb-[5%] min-h-[20vh] h-auto w-[90%] items-center ">
                ...
                <p className="text-[#000000] text-[1.2rem] md:text-[1.5rem] lg:text-[3rem] font-bold text-center mb-[5%]">RESULTADOS</p>
                <p className="text-[#000000] text-[0.8rem] md:text-[1rem] lg:text-[1.2rem] mb-[2%]">{projeto.resultados}</p>
            </div>
            ...
            {projeto.links && (
                <div className="flex flex-col mx-[5%] mb-[5%] min-h-[20vh] h-auto w-[90%] items-center">
                    ...
                    <p className="text-[#000000] text-[1.2rem] md:text-[1.5rem] lg:text-[3rem] font-bold text-center mb-[5%]">LINKS DO PROJETO</p>
                    {(projeto.links as string[]).map((url, index) => (
                        <a key={index} href={url} className="text-[0.7rem] break-all md:text-[1rem] lg:text-[1.2rem] text-[#F1863D] mb-[2%]">{url}</a>
                    ))}
                </div>
            )}
        </div>
