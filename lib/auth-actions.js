...
//   const supabase = await createSupabaseServer();
//   //Isso não vai ficar dessa forma, depois vamos chamar uma função que vai fazer o upload definitivo.
...
export async function insertdatanew(nome, datanasc,genero,github,linkedin,senha_velha,senha_nova,confirmar_senha) {
    nome = nome || null;
    datanasc = datanasc || null;
    genero = genero || null;
    github = github || null;
    linkedin = linkedin || null;
    senha_velha = senha_velha || null;
    senha_nova = senha_nova || null;
    confirmar_senha = confirmar_senha || null;
